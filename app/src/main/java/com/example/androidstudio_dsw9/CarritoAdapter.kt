...
class CarritoAdapter(
    ...
    private fun eliminarEnServidor(context: android.content.Context, producto: Producto, position: Int) {
        ...
        val request = Request.Builder()
            .url("http://192.168.0.4/miapp/eliminarproducto.php")  // URL para la realizar la consulta a la base de datos
            .post(requestBody)
            .build()
    ...
    private fun actualizarEnServidor(context: android.content.Context, producto: Producto) {
        ...
        val request = Request.Builder()
            .url("http://192.168.0.4/miapp/actualizarcarrito.php")  // URL para la realizar la consulta a la base de datos
            .post(requestBody)
            .build()
