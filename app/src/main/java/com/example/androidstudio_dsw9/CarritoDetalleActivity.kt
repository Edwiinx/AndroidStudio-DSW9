...
class CarritoDetalleActivity : AppCompatActivity() {
    ...
    private var idUsuario: Int = 0 // Para almacenar el id_usuario
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Obtener el id_usuario desde el Intent que se pasó
        idUsuario = intent.getIntExtra("id_usuario", 0) // Si no se pasa un valor, será 0

        // Asegúrate de que se haya recibido un id_usuario válido
        if (idUsuario == 0) {
        ...
        // Cargar los productos del carrito para el id_usuario correspondiente
        cargarCarrito()
    }
